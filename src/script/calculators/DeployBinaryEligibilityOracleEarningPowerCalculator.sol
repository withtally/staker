...
/// @title DeployBinaryEligibilityOracleEarningPowerCalculator
/// @author [ScopeLift](https://scopelift.co)
/// @notice An abstract contract that has the interface and logic necessary to
/// deploy a `BinaryEligibilityOracleEarningPowerCalculator` contract. This contract is part of our
/// modular deployment system and can be combined with other script contracts in order to deploy
