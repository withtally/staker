...
/// StakerTestBase and simulates calling notify function on TransferFromRewardNotifier. This
/// contract is designed to be used in conjunction with the deployment scripts in
