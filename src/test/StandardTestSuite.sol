...
abstract contract StakeBase is StakerTestBase {
  ...
  function testForkFuzz_TwoDepositorsEarnRewardsOverMultiplePeriods(
    ...
    uint256 _earnedRewards2Duration1 =
      _calculateEarnedRewards(_deposit2.earningPower, _rewardAmount, _percentDuration1);
    uint256 _earnedRewards2Duration2 = _calculateEarnedRewards(
