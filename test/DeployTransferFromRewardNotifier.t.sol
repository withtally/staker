...
import {DeployTransferFromRewardNotifierHarness} from
  "./harnesses/DeployTransferFromRewardNotifierHarness.sol";
...
contract DeployTransferFromRewardNotifierTest is Test {
  ...
  DeployTransferFromRewardNotifierHarness deployScript;
  ...
  function setUp() public {
    ...
    deployScript = new DeployTransferFromRewardNotifierHarness(rewardToken, govToken);
  }
}
...
contract run is DeployTransferFromRewardNotifierTest {
  function test_DeployTransferFromRewardNotifier() public {
    ...
    assertEq(address(deployScript.notifierRewardSource()), address(_transferFromNotifier.rewardSource()));
  }
}
