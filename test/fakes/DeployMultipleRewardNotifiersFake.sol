...
import {DeployTransferRewardNotifier} from
...
contract DeployMultipleRewardNotifiersFake is
  DeployBase,
  DeployStaker,
  ...
  DeployIdentityEarningPowerCalculator
{
  ...
  {
    return TransferRewardNotifierConfiguration({
      initialRewardAmount: initialRewardAmount,
      initialRewardInterval: initialRewardInterval,
      initialOwner: notifierOwner
    });
  ...
  function _deployRewardNotifiers(StakerUpgradeable _staker)
    internal
    virtual
    override(DeployBase, DeployMintRewardNotifier, DeployTransferRewardNotifier)
  {
    DeployMintRewardNotifier._deployRewardNotifiers(_staker);
    DeployTransferRewardNotifier._deployRewardNotifiers(_staker);
  }
