  ...
  DeployIdentityEarningPowerCalculator
{
  ...
  function _deployRewardNotifiers(Staker _staker)
    internal
    virtual
    override(DeployBase, DeployMinterRewardNotifier, DeployTransferRewardNotifier)
  {
    DeployMinterRewardNotifier._deployRewardNotifiers(_staker);
