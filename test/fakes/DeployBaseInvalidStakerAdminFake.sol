...
contract DeployBaseInvalidStakerAdminFake is
  DeployBase,
  DeployStaker,
    ...
    returns (Staker)
  {
    ...
    ERC1967Proxy proxy = new ERC1967Proxy(
      ...
      abi.encodeCall(
        ...
        (_config.rewardToken, IERC20Staking(address(_config.stakeToken)), 1e18, makeAddr("Anyone but the deployer"), _config.maxBumpTip, _config.earningPowerCalculator, name)
      )
    );
